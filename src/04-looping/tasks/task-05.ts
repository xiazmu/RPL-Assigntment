...
const averageScores: number = totalScores / scores.length

console.log("=== Progamming CompetitionResults ===")
...
console.log(`Students Without Medal     : ${noMedal}`)
console.log(`Average Competition Score : ${averageScores}`)